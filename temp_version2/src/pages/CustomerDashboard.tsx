...
export default function CustomerDashboard() {
  ...
  const fetchAll = async () => {
    try {
      const [reqData, svcData, txData, tkData, ctData] = await Promise.all([
  ...
  const handleBecomeProvider = async () => {
    ...
    if (!user.isVerified) {
      showNotification("You must complete Identity Verification (KYC Level 1) before becoming a provider.", "error");
    ...
    try {
      ...
      showNotification("Application submitted! Your account is now pending verification.", "success");
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full p-3 bg-neutral-50 dark:bg-neutral-800 border border-app-border rounded-xl text-sm font-bold text-app-text"
                >
        ...
        {showBecomeProvider && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-2xl">
                  <CheckCircle2 className="w-6 h-6 text-emerald-500 shrink-0" />
                  <div className="space-y-1">
                    <p className="font-bold text-sm text-app-text">Set Your Own Rates</p>
                ...
                <div className="flex items-start gap-4 p-4 bg-neutral-50 dark:bg-neutral-800 rounded-2xl">
                  <CheckCircle2 className="w-6 h-6 text-emerald-500 shrink-0" />
                  <div className="space-y-1">
                    <p className="font-bold text-sm text-app-text">Flexible Schedule</p>
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  onClick={() => setShowBecomeProvider(false)}
                  className="w-full py-4 bg-neutral-50 dark:bg-neutral-800 text-neutral-400 dark:text-neutral-500 rounded-2xl font-bold text-sm hover:text-neutral-900 dark:hover:text-white transition-all"
                >
                  Maybe Later
                </button>
              </div>
