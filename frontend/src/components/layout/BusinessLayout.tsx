...
const SIDEBAR_LINKS = [
  ...
  { label: 'Schedule', icon: CalendarClock, path: 'schedule' },
        ...
        <div className="w-full px-3 sm:px-5 lg:px-6 h-16 flex items-center">
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <span>
              ...
              <span className="hidden text-[10px] font-bold uppercase tracking-[0.12em] text-[#4a4f70] sm:block">Business</span>
            </span>
          </Link>
          ...
          <div className="ml-auto flex items-center gap-3 sm:gap-4">
            <Link
              to="/app/home"
              className="hidden sm:flex items-center gap-2 rounded-xl border border-[#2a2f4a] bg-[#1e2235] px-4 py-2 text-[10px] font-black uppercase tracking-widest text-[#8b90b0] transition hover:border-[#2b6eff] hover:text-white"
            >
      ...
      <div className="flex flex-1">
        ...
        <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:border-r lg:border-[#2a2f4a] lg:bg-[#0d0f1a]">
          <div className="flex flex-col h-full p-4">
            ...
            <div className="mt-auto pt-4 border-t border-[#2a2f4a]">
              <button
            ...
            <>
              ...
              >
                <div className="flex justify-between items-center mb-8">
                  <h2 className="text-xl font-black italic uppercase tracking-tight text-[#f0f2ff]">Business</h2>
